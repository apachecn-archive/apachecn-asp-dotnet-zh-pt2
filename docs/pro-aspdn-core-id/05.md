...
在这一章中，我将解释如何配置 Identity，包括如何支持来自谷歌、脸书和 Twitter 的第三方服务。这些配置选项中的一些是 ASP.NET Core 平台的一部分，但是因为它们与 ASP.NET Core 身份紧密相关，所以我还是把它们包括进来了。表 [5-1](#Tab1) 将配置选项放在上下文中。
