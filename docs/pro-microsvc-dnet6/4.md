...
Kestrel 是 ASP.NET 核心应用的跨平台 web 服务器。更多信息，请访问 [`https://docs.microsoft.com/en-us/aspnet/core/fundamentals/servers/kestrel?view=aspnetcore-6.0`](https://docs.microsoft.com/en-us/aspnet/core/fundamentals/servers/kestrel%253Fview%253Daspnetcore-6.0) 。
